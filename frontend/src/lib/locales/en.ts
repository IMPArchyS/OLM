export default {
    ...
    experiments: {
        ...
        deletedLinkedDeviceWarningShort: 'Linked deleted device',
        ...
        inputArgNameRequired: 'Input argument name is required',
    ...
    queues: {
        ...
        no_last_device: 'No previous run device found for selected experiment.',
        last_device_label: 'Last run device',
        any_selected_label: 'Selected compatible device',
        pick_device_label: 'Select compatible device',
        target_missing: 'No target device available for selected strategy.',
    },
    profile: {
        title: 'Profile',
