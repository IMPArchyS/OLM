export default {
    ...
    queues: {
        ...
        target_strategy_title: 'Queue target strategy',
        target_same_last: 'Queue on same device as last run',
        target_any: 'Queue on any compatible device',
        target_manual: 'Queue on selected compatible device',
