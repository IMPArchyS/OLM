...
Revision ID: 03_create_software_table
Revises: 02_create_server_table
...
revision: str = '03_create_software_table'
down_revision: Union[str, Sequence[str], None] = '02_create_server_table'
