...
Revision ID: 02_create_server_table
Revises: 01_create_device_type
...
revision: str = '02_create_server_table'
down_revision: Union[str, Sequence[str], None] = '01_create_device_type'
