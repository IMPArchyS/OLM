...
Revision ID: 007_create_device_software_table
Revises: 006_create_argument_table
...
revision: str = '007_create_device_software_table'
down_revision: Union[str, Sequence[str], None] = '006_create_argument_table'
