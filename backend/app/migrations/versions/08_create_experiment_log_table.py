...
Revision ID: 08_create_experiment_log_table
Revises: 07_create_reservation_table
...
revision: str = '08_create_experiment_log_table'
down_revision: Union[str, Sequence[str], None] = '07_create_reservation_table'
