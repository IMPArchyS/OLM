...
def get_device_webrtc_grant(db: DbSession, server_id: int, device_name: str, _: CurrentUser):
...
def refresh_device_webrtc_grant(db: DbSession, server_id: int, device_name: str, grant_token: GrantRefreshRequest, _: CurrentUser):
    health_url = check_device_server_url(db, server_id)
